...
var TypeChecker = /** @class */ (function () {
        ...
        if (!isPlainObject(value)) {
            ...
            Object.keys(rule).forEach(function (subKey) {
                if (!hasOwnProperty(value, subKey)) {
                    // 捕获所有KEY_UNDEFINED错误
                    _this.markError_(subKey, void 0, ErrorType.KEY_UNDEFINED);
                }
                else {
    ...
    TypeChecker.prototype.markError_ = function (key, value, error) {
        if (error) {
            this.globalError_.push(__assign({ key: key, value: value }, error));
        }
    };
...
var TEqual = /** @class */ (function (_super) {
    __extends(TEqual, _super);
    function TEqual(value) {
        var _this = _super.call(this) || this;
        _this.__checkable__ = 'equal';
        _this.value_ = value;
        return _this;
    }
    TEqual.prototype.check = function (value) {
...
function instance(Checkable) {
    return function () {
        ...
        return new (Checkable.bind.apply(Checkable, __spreadArrays([void 0], args)))();
    };
}
var type = {
